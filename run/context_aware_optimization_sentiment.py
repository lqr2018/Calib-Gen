...
class CommandExecutor:
    def __init__(self, base_command1, variations1, variations2, max_concurrent_processes=1):
        self.base_command1 = base_command1
    ...
    def _generate_commands(self):
        for variation1 in self.variations1:
            for variation2 in self.variations2:
                command = self.base_command1 + [
                    "--prompts_setting", str(variation1["prompts_setting"]),
                    "--prefix_setting", str(variation1["prefix_setting"]),
...
if __name__ == "__main__":
    base_command1 = [
        ...
        "python", "scripts/data_generation/sentiment_context_aware_optimization.py",
    ]
    ...
    executor = CommandExecutor(base_command1, variations1, variations2, max_concurrent_processes=1)
