...
from methods.method_fudge.data import Dataset
from methods.method_fudge.model import Model
from methods.method_fudge.util import save_checkpoint, ProgressMeter, AverageMeter, num_params, pad_mask
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, required=True,
                        choices=['toxicity', 'sentiment_pos', 'sentiment_neg'])
