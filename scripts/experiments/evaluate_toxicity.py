...
def process_prompt(prompt,
                   ...
                   fudge_model_string,
                   display):
    original_text = json.loads(prompt)['prompt']["origin_text"] if method == "pregen" else None
    ...
    try:
        summary_scores, _ = get_perspective_api_scores(generated_text, display)
        continuation_scores, _ = get_perspective_api_scores(raw_text, display)
